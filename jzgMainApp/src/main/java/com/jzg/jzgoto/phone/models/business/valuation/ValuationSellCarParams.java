 ...
 * Function :
 */
public class ValuationSellCarParams extends BaseParamsModels{
    private String mUrl = HttpServiceHelper.BASE_URL+ "/APPV5/SellCarAppraiseResult.ashx";

 //   /APPV5/SellCarAppraiseResult.ashx?op=GetValuationInfo&
 // sourcetype=3&uid=13&styleid=15190&CityId=201&cityname=北京&mileage=2.1&regdate=2015-01-01
    public String uid = "0";
