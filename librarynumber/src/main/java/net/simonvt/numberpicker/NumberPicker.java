...
public class NumberPicker extends LinearLayout {
     ...
     */
    private static final int UNSCALED_DEFAULT_SELECTION_DIVIDER_HEIGHT = 20;
    ...
    private int curWidthSize;
    
    private int curHeightSize;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        //mAdjustScroller = new Scroller(getContext(), new DecelerateInterpolator(10f));
        mAdjustScroller = new Scroller(getContext(), null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int heightSize = resolveSizeAndStateRespectingMinSize(mMinHeight, getMeasuredHeight(),
                heightMeasureSpec);
        curWidthSize = widthSize;
        curHeightSize = heightSize;
    ...
    protected void onDraw(Canvas canvas) {
     ...
     // draw the selection dividers
        if (mSelectionDivider != null) {
            ...
            mSelectionDivider.setBounds(0, topOfTopDivider, getRight(), bottomOfBottomDivider);
            mSelectionDivider.draw(canvas);
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE) {
               ...
               // Rect rect =  new Rect(0, curHeightSize/5*2,curWidthSize, curHeightSize/5*3);
                
                //testPaint.setAlpha(5);
