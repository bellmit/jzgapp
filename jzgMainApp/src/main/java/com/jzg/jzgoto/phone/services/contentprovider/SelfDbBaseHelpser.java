...
/**
 * @Description: 自定义数据库
 * @Package com.jzg.jzgoto.phone.services.contentprovider SelfDbBaseHelpser.java
 * @author gf
 * @date 2016-6-16 上午10:56:36
 */
public abstract class SelfDbBaseHelpser {
     ...
     */
    public SelfDbBaseHelpser(Context context,String path, String name, CursorFactory factory, int version) {
        this(context, path,name, factory, version, null);
    }
