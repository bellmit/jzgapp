...
public class CustomListView extends ListView {
    ...
    public void onGrab(int position, LinearLayout selectedView) {
        mTotalOffset = 0;
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        MyFocusCarListAdpater1 adapter = ((MyFocusCarListAdpater1)getAdapter());
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mCellIsMobile) {
                    ...
                    if(mHoverCell!=null&&mHoverCellCurrentBounds!=null){
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            if(null != switchView) {
                selectedView = (LinearLayout)switchView.findViewById(
                        R.id.ll_lineaer);
            }
